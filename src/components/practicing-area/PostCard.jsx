...
const PostCard = ({ attorney, index }) => {
  ...
  return (
    <motion.div
      ...
      key={attorney.name}
    >
      <Link href={attorney.url} className='block p-5 rounded-lg duration-300 ease-in-out transition-all bg-[#01312B] group relative top-0 hover:-top-1 hover:bg-[#012924] h-full'>
        <Image
          src={attorney.image}
          width= {1000}
          height={1000}
