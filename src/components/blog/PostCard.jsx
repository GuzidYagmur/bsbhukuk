...
const PostCard = ({ blog, index }) => {
  ...
  return (
    ...
    >
      <Link
        href={blog.url}
        className="group flex items-stretch rounded-lg duration-300 ease-in-out transition-all bg-[#01312B] relative top-0 hover:-top-1 hover:bg-white h-full overflow-hidden text-left"
      >
        <Image
          src={blog.image}
          width={1000}
