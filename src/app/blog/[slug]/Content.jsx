			...
			<div className="bg-white py-10 md:py-20 mt-20 md:mt-20 mb-0 px-4">
				<div className="max-w-[960px] mx-auto">
					...
					<div className="flex justify-center mt-10">
						<Link
							href="/blog"
							className="mb-5 sm:mb-0 text-center w-fill sm:w-auto inline-block py-4 px-5 rounded-[30px] bg-secondary text-dark border border-transparent transition-all duration-300 ease-in-out hover:border-secondary hover:bg-transparent hover:text-dark"
						>
							Diğer Bloglar{" "}
						</Link>
					</div>
