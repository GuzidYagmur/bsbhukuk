...
const Content = ({ attorney }) => {
	const attorneys = allAttorneys.sort((a, b) =>
	...
	return (
		...
		>
				...
				<div className="md:flex justify-between">
					...
					<div className="md:w-6/12">
						...
						<div className="mb-10 justify-center text-center md:justify-start block sm:flex items-center space-x-0 sm:space-x-5">
							<Link
								href="/"
								className="inline-flex items-center mb-5 sm:mb-0 text-center justify-center w-full sm:w-auto gap-x-2 py-3 px-5 rounded-[30px] bg-secondary text-dark border border-transparent transition-all duration-300 ease-in-out hover:border-white hover:bg-transparent hover:text-white"
							>
								<MdCall /> <span>Call Now</span>
							</Link>
							<span className="text-darkGreen block mb-5 md:mb-0 md:inline-block">
								or
							</span>
							<Link
								href="/"
						...
						<div>
							<Link
								href="/attorneys"
								className="inline-flex mb-2 text-center text-white border-b border-b-transparent transition-all duration-300 ease-in-out hover:border-b-white hover:text-opacity-70"
							>
								Back to List of Attorneys
							</Link>
						</div>
					</div>
				</div>
			...
			<div className="max-w-[960px] mx-auto mt-20 lg:mt-32">
				<h2 className="text-3xl font-serif mb-10 text-center text-white">
					More Attorneys
				</h2>
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 items-stretch">
					{attorneys
						.filter((a) => attorney.name !== a.name)
						.map((item, idx) => {
				...
				<div className="flex justify-center mt-10">
					<Link
						href="/attorneys"
						className="mb-5 sm:mb-0 text-center w-full sm:w-auto inline-block py-4 px-5 rounded-[30px] bg-secondary text-dark border border-transparent transition-all duration-300 ease-in-out hover:border-white hover:bg-transparent hover:text-white"
					>
						View All Attorneys
					</Link>
				</div>
